 ...
 */
 ...
 (function () {
   const phoneMaskList = document.querySelectorAll('.phone-mask'),
     ...
     expiryMonthMask = document.querySelector('.expiry-month-mask'),
     expiryYearMask = document.querySelector('.expiry-year-mask'),
