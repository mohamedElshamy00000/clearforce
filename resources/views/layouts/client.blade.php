...
<html
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('backend/assets/vendor/libs/shepherd/shepherd.css') }}" />
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WHRN859F"
      ...
      <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
        <div class="layout-container">
          ...
          @include('backend.inclouds.client.nav')
          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              <!-- Menu -->
              @include('backend.inclouds.client.side')
              <!-- / Menu -->
      ...
      <script src="{{ asset('backend/assets/vendor/libs/shepherd/shepherd.js') }}"></script>

      <script src="{{ asset('backend/assets/js/wizard-ex-property-listing.js') }}"></script>
      <script src="{{ asset('backend/assets/js/form-layouts.js') }}"></script>
      <script src="{{ asset('backend/assets/js/forms-selects.js') }}"></script>
      <script src="{{ asset('backend/assets/js/extended-ui-tour.js') }}"></script>
