...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Projects /</span> Shipping Ways</h4>
<div class="row">
    <div class="col-md-4">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="mb-0"><span id="actiontype">Add</span> Shipping Ways</h5>
            </div>
            <div class="card-body">
                {{-- add form --}}
              <form action="{{ route('shipping.way.store') }}" method="POST" id="addForm">
                @csrf
                <div class="mb-3">
              ...
              {{-- edit form --}}
              <form action="{{ route('shipping.way.update') }}" method="POST" id="editForm" style="display: none">
                @csrf
                <div class="mb-3">
                    <label class="form-label" for="name">Name</label>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="table-responsive text-nowrap mb-3">
                <table class="table yajra-datatable" id="productTypes">
                    <thead>
                        <tr>
                            <th>name</th>
                            <th>ports</th>
