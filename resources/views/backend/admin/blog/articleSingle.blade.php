...
<h4 class="py-3 mb-2">
    <div><span class="text-muted fw-light">Blog /</span> Edit Article</div>
</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <img class="card-img-top mb-4" src="{{ asset('assets/blog/' . $article->media->file_name ) }}">
                
                <form method="post" id="blogcreate" action="{{ route('admin.article.update', $article->slug) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="textarea-editor" name="content" style="display: none" class="w-100 p-4" rows="10">{!! $article->content !!}</textarea>
                        @error('content')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group text-start mt-3">
                        ...
                        <div class="form-check form-check-inline ms-3 mt-3">
                            <input class="form-check-input" type="radio" name="status" id="inlineRadio1" @if ($article->status == 1) checked @endif value="1">
                            <label class="form-check-label" for="inlineRadio1">active</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input"  type="radio" name="status" id="inlineRadio2" @if ($article->status == 0) checked @endif value="0">
